...
"""
abstract type AbstractHierarchySolver end
...
"""
struct QPSolver{TP<:HierarchyProblem, TC<:QPPrecomputed} <: AbstractHierarchySolver
    problem::TP
    solver_type::Symbol
    precomputed::TC
end
...
"""
struct NonlinearSolver{TP<:HierarchyProblem, TC<:NamedTuple} <: AbstractHierarchySolver
    problem::TP
    precomputed::TC
    options::NamedTuple
end
