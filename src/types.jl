...
- `options::NamedTuple` - Solver options (max_iters, tol, verbose, use_armijo, recompute_K_in_linesearch)
"""
...
function NonlinearSolver(
    ...
    @timeit to "NonlinearSolver construction" begin
        ...
        options = (; max_iters, tol, verbose, use_armijo, recompute_K_in_linesearch)
    end
