# For interactive development, start Julia from the project root, then run:
# using Revise; includet("examples/test_automatic_solver.jl")
...
nplayer_hierarchy_navigation_nonlinear_dynamics(x0, x_goal, z0_guess, R, T, Δt; max_iters = 5000)
