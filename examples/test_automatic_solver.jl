...
function nplayer_hierarchy_navigation_nonlinear_dynamics(x0, x_goal, z0_guess, R, T, Δt; max_iters = 50, verbose = false)
	...
	function J₂(z₁, z₂, z₃, z₄, θ)
		...
		control + collision + 2y_deviation + zero_heading + 0.3velocity
	...
	function J₃(z₁, z₂, z₃, z₄, θ)
		...
		tracking + control + collision + 2y_deviation + zero_heading + 0.5velocity
	...
	function J₄(z₁, z₂, z₃, z₄, θ)
		...
		control + collision + 2y_deviation + zero_heading + 0.5velocity
	end
