...
BENCHMARK PROTOCOL:
  Before PR #1:  bash scripts/perf_implementation_plan.sh baseline
  After each merge: bash scripts/perf_implementation_plan.sh bench
  Record results in each PR description under "## Benchmark Results"

===========================================================================
  EXECUTION ORDER (29 PRs, sequentially stacked)
===========================================================================

── P4 Trivials (PRs 1-7) ─────────────────────────────────────────────────
  Low-risk warmup. Each is a 1-2 line change. Builds confidence in the
  benchmark harness before touching hot-path code.

  PR  1 │ #20 │ q2p │ perf/20-inline-utils
        ...
        │
  PR  2 │ #25 │ 7r0 │ perf/25-lazy-warn-linesearch
        ...
        │
  PR  3 │ #27 │ 9ve │ perf/27-debug-getter
        ...
        │
  PR  4 │ #28 │ 1q1 │ perf/28-collect-values
        ...
        │ Impact: negligible
        │
  PR  5 │ #29 │ 309 │ perf/29-fuse-convergence
        ...
        │
  PR  6 │ #26 │ 311 │ perf/26-nan-fill-error
        ...
        │ Impact: negligible (error path only)
        │
  PR  7 │ #24 │ 4sk │ perf/24-symbolics-num-conversion
...
── P1 Hot-Path (PRs 8-12) ────────────────────────────────────────────────
  The main solve-time improvements. These affect every Newton iteration.

  PR  8 │ #2  │ 65s │ perf/02-norm-to-dot
        ...
        │
  PR  9 │ #1  │ r96 │ perf/01-linesearch-buffer
        ...
        │
  PR 10 │ #3  │ c0l │ perf/03-neg-f-buffer
        ...
        │
  PR 11 │ #5  │ bda │ perf/05-closure-outside-loop
...
── P1-P2 Solve Path (PRs 13-16) ──────────────────────────────────────────
  ...
  PR 14 │ #16 │ 3ij │ perf/16-parameter-dict-skip
        ...
        │
  PR 15 │ #13 │ dyl │ perf/13-reduce-vcat-to-copyto
        ...
        │
  PR 16 │ #22 │ pr8 │ perf/22-jacobian-buffer-copy
...
── P1 Setup/Precomputation (PRs 17-19) ───────────────────────────────────
  Major setup-time improvements. Graph caching is the biggest win.

  PR 17 │ #11 │ 9gl │ perf/11-cache-graph-traversals
        ...
        │
  PR 18 │ #12 │ 40x │ perf/12-ws-single-vcat
        ...
        │
  PR 19 │ #23 │ e07 │ perf/23-all-variables-single-pass
...
── P2 KKT Deduplication (PRs 20-24) ──────────────────────────────────────
  Eliminate redundant computations in KKT system construction.

  PR 20 │ #14 │ 6te │ perf/14-cache-extractor-matrices
        │ Cache extractor matrices in qp_kkt.jl (built twice per pair)
        │ File: src/qp_kkt.jl:123,140
        │ Base: perf/23-all-variables-single-pass
        │ TDD: test KKT conditions identical with cached extractors
        │ Impact: 5-10% QP setup speedup
        │
  PR 21 │ #15 │ iyk │ perf/15-dedup-k-flattening
        ...
        │
  PR 22 │ #18 │ br6 │ perf/18-cache-topo-sort
        ...
        │
  PR 23 │ #19 │ ge7 │ perf/19-optimize-bfs-collect
        ...
        │
  PR 24 │ #21 │ cbz │ perf/21-sparse-pattern-cache
        │ Pre-compute sparse pattern for use_sparse mode
        │ File: src/nonlinear_kkt.jl:732
        │ Base: perf/19-optimize-bfs-collect
        │ TDD: test K solve identical with cached pattern vs fresh sparse()
        │ Impact: 5-10% if use_sparse=:always

── P2-P3 Type Stability (PRs 25-29) ──────────────────────────────────────
  Deepest refactors. Touch type definitions. Most invasive → do last.

  PR 25 │ #10 │ ldj │ perf/10-union-buffer-removal
        ...
        │
  PR 26 │ #8  │ ggt │ perf/08-concrete-precomputed
        ...
        │
  PR 27 │ #9  │ asz │ perf/09-hierarchy-problem-params
        ...
        │
  PR 28 │ #6  │ xhy │ perf/06-typed-function-storage
        ...
        │
  PR 29 │ #7  │ vqy │ perf/07-typed-kkt-dicts
...
===========================================================================
  ...
  ## Summary
  Performance optimization: [finding title]
...
===========================================================================
  ...
  PRs  1-7  (P4 trivials):     <1% combined
  PRs  8-12 (P1 hot-path):     8-15% solve time
  PRs 13-16 (P1-P2 solve):     2-5% solve time
  PRs 17-19 (P1 setup):        30-60% construction time
  PRs 20-24 (P2 KKT dedup):    5-10% construction time
  PRs 25-29 (P2-P3 types):     5-10% solve time
...
case "$cmd" in
    ...
    help|*)
        ...
        echo ""
        echo "Commands:"
        echo "  plan      - Print full 29-PR execution plan"
